...
export const processInput = (payload, state) => {
  ...
  const newPayload = [...new Set([...payloadBody.coupons, ...claimedCouponCodes, ...unClaimedCouponCodes])];

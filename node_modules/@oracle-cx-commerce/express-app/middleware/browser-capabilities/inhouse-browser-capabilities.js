...
/**
 * This file was derived from https://github.com/Polymer/tools/blob/master/packages/browser-capabilities/src/browser-capabilities.ts which is under
 *
...
function browserCapabilities(userAgent) {
  const ua = new UAParserJS.UAParser(userAgent);

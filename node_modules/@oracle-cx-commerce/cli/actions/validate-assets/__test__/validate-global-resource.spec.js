...
describe('validate-assets:all  -  all the tests that will invoke validate-assets with different options', () => {
  ...
  test('validate-assets:validate-global-resource-class-exists - check that global resource class is present', () => {
    const newPath = path.resolve(path.relative('.', __dirname), '..', 'global-resource.js');

...
function sixteenthExampleActionSaga(action) {
  // Place to implement what the action will do
  console.warn('Action: sixteenthExampleAction have been invoked. No further action.');
}

/**
 * The sixteenthExampleAction action.
 *
...
export default {
  *saga() {
    yield takeEvery('sixteenthExampleAction', sixteenthExampleActionSaga);
  }
};

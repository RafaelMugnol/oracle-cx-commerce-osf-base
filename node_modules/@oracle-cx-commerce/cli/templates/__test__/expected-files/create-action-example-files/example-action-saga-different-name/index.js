...
function* twelfthExampleActionSaga(action) {
  const response = yield endpointSaga({action, payload: action.payload, endpointId: 'endpointName'});

  return response;
}

/**
 * The twelfthExampleAction action.
 *
...
export default {
  *saga() {
    yield takeEvery('twelfthExampleAction', twelfthExampleActionSaga);
  }
};

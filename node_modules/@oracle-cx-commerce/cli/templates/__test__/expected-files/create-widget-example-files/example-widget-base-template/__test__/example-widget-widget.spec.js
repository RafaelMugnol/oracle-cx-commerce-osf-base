...
export const ExampleWidget = () => import('../index');

describe('ExampleWidget renders correctly and shows after changing visible state', () => {
  /**
   * Reference to dynamic imported comps to resolve and preload.
   */
  const comps = {ExampleWidget};
  beforeAll(async () => {
    /**
  ...
  it('ExampleWidget works as expected', async done => {
    /**

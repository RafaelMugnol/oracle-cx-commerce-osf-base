export default {
  ...
  input: '@oracle-cx-commerce/blank-store/src/plugins/endpoints/oas2LocalSwaggerEndpointExample/list-addresses/schema/input.json',
  ...
  output: '@oracle-cx-commerce/blank-store/src/plugins/endpoints/oas2LocalSwaggerEndpointExample/list-addresses/schema/output.json',
  packageId: ''
};

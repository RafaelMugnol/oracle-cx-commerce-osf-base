export default {
  ...
  input: '@oracle-cx-commerce/blank-store/src/plugins/endpoints/oas2SwaggerEndpointExample/list-addresses/schema/input.json',
  ...
  output: '@oracle-cx-commerce/blank-store/src/plugins/endpoints/oas2SwaggerEndpointExample/list-addresses/schema/output.json',
  packageId: ''
};

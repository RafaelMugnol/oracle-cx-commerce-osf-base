...
const API_NAME = 'oas2SwaggerEndpointExample';

export const createOas2SwaggerEndpointExampleEndpointFactory = createEndpointFactory({
  apiCatalogPaths: ['/ccstore/v1/metadata-catalog'],

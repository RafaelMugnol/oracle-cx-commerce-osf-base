...
function addValidationOption() {
  return this.option('--no-validation', ___`Do not validate assets when running yarn deploy.`);
}
addValidationOption.bind(program);
...
Object.getPrototypeOf(program).addValidationOption = addValidationOption;
...
program
  ...
  .on('--help', function () {
    console.log();
    console.log(___`Examples:`);
    console.log('  $ occ download-assets my-app');
    console.log('  $ occ download-assets my-app --reset');
  })
...
program
  ...
  .option('--fromClassic', 'Convert the assests from SF classic to OSF')
  .addCommonOccServerOptions()
  .on('--help', function () {
    console.log();
    console.log(___`Example:`);
    ...
    console.log('  $ occ create-app @acme/my-app --fromClassic');
  })
...
// Validate Assets
program
  .command('validate-assets [appName]')
  .description(___`Validate all assets, including components, containers, pages and slots for the application.`)
  .on('--help', function () {
    console.log();
    console.log(___`Example:`);
    console.log('  $ occ validate-assets');
  })
  .action(run(validateAssets));

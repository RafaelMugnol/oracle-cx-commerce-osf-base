 ...
 *
 * This search page configuration must be pushed to Guided Search using the "gsadmin" REST API.
 * For example, do a POST to "/gsadmin/v1/cloud/pages/Default/osf" with the JSON object of this module.
 */
module.exports = {
  contentType: 'Page',
  ...
  contentItem: {
    ...
    results: {
      ...
      attributes: [
        ...
        'product.route',
        // The following is an example of a custom product property that the ProductResultColorSwatches
      ...
      childRecordAttributes: [
        'sku.activePrice',
        // The following is an example of a custom sku property that the ProductResultColorSwatches

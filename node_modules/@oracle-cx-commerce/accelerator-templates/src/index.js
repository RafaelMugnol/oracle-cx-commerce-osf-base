...
const {convertClassicAssets} = require('./convert-classic-assets-utils');
 ...
 */
async function createAppFromTemplate(templateName, appPackageName, fromClassic, appServerAdmin, appKey) {
  if (fromClassic) {

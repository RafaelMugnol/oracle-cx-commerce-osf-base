...
import css from '@oracle-cx-commerce/react-widgets/cart/cart-order-summary/styles.css';
...
const CartOrderSummary = props => {
  ...
  return (
    <Styled id="CartOrderSummary" css={css}>
      <>
        {currentOrder &&
          ((currentOrder.id && numberOfItems > 0) || currentOrder.state === ORDER_STATE_PENDING_PAYMENT) && (
            <div className="CartOrderSummary">
              <div className="CartOrderSummary__Wrapper">
                <h3 className="CartOrderSummary__Heading">{headingOrderSummary}</h3>
                <OrderSummary
                  order={currentOrder}
...
export default connect(getOrderData)(CartOrderSummary);

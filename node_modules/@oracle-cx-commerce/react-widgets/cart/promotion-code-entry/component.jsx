...
import css from '@oracle-cx-commerce/react-widgets/cart/promotion-code-entry/styles.css';
 ...
 * @param {*} props
 */
const PromotionCodeEntry = props => {
    ...
    <Styled id="PromotionCodeEntry" css={css}>
      {props.displayPromoCodeEntry && (
        <div className="PromotionCodeEntry">
          ...
          >
            <span className="PromotionCodeEntry__Icon">{showPromoForm ? <Minus /> : <Plus />}</span>
            <span className="PromotionCodeEntry__Label">{textApplyPromoCode}</span>
          </span>
          {showPromoForm && (
...
export default connect(getComponentData)(PromotionCodeEntry);

...
import css from '@oracle-cx-commerce/react-widgets/cart/cart-container/styles.css';
  ...
  return (
    <Styled id="CartContainer" css={css}>
      <div className="CartContainer">
        <h1 className="CartItemDetails__Heading">{headingYourCart}</h1>
...
CartContainer.propTypes = {
  /**
   * Boolean flag to indicate whether Cart is loaded or not.
   */
  isGetCartInProgress: PropTypes.number.isRequired,

  /**
   * Set of regions defined in Cart Container layout.
   */
  regions: PropTypes.PropTypes.arrayOf(PropTypes.string).isRequired
};

export default connect(getComponentData)(CartContainer);

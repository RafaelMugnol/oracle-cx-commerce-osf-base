...
const PromotionsDisplay = props => {
  ...
  return (
    <Styled id="PromotionsDisplay" css={css}>
          ...
          <Alert id="PromotionsSuccessAlert" type="success">
            ...
            {Object.keys(orderCouponsMap).length > 0 &&
              Object.keys(orderCouponsMap || {}).map(promocode => (
                <div key={promocode}>
                  <div className="">
                    <span className="PromotionsDisplay__boldText">
...
export default connect(getComponentData)(PromotionsDisplay);

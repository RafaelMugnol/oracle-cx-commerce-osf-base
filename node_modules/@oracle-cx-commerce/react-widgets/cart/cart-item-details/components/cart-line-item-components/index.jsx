...
import css from '@oracle-cx-commerce/react-widgets/cart/cart-item-details/components/cart-line-item-components/styles.css';
...
export const CartItemUpdateError = props => {
  ...
  return (
    errorMessage && (
      <Styled id="CartItemUpdateError" css={css}>
        <div className="CartItemUpdateError">{errorMessage}</div>
      </Styled>
    )
  );
};
...
export const CartItemAddToWishListLink = props => {
  ...
  return (
    <Styled id="CartItemAddToWishListLink" css={css}>
      <div className="CartItemAddToWishListLink">
        <Wishlist />
        <button type="button" className="CartItemAddToWishListLink__WishlistText">
...
export const CartItemRemoveLink = props => {
  // resources.
  const {actionRemoveItem, currentOrder, setInvalidItemsOnQuantityChange = noop} = props;
  const {shippingGroups} = currentOrder;
  ...
  return (
    <Styled id="CartItemRemoveLink" css={css}>
      <div className="CartItemRemoveLink">
        <button
          type="button"
          onClick={() => {
            removeItem(commerceItem.id);
...
export const CartItemQuantityDisplayAndUpdate = props => {
  ...
  return (
    <Styled id="CartItemQuantityDisplayAndUpdate" css={css}>
      <div key={`${shippingGroupId + commerceItem.id}-${shippingGroupCommerceItem.quantity}`}>
        {!(showInput || shippingGroupCommerceItem.quantity >= 10) ? (
          <Dropdown
            ...
            className={`CartItemQuantityDisplayAndUpdate ${
              errorMessage !== '' ? 'CartItemQuantityDisplayAndUpdateError' : ''
            }
          `}
          >
            {SELECT_OPTIONS}

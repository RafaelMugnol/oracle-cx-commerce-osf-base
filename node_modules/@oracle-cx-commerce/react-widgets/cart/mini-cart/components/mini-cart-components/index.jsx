...
import css from '@oracle-cx-commerce/react-widgets/cart/mini-cart/components/mini-cart-components/styles.css';
  ...
  return (
    <Styled id="MiniCartButtons" css={css}>
      <div className="MiniCart__Buttons">
        ...
        {displayCheckoutButtonOnMiniCart ? (
          <div>
            <Link className="button" onClick={closeMiniCart} href={getCheckoutLink(isUserLoggedIn)}>
              {actionCheckout}
            </Link>
          </div>
        ) : null}

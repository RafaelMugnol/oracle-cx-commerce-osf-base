...
import {REDIRECT_TO_HOME_PAGEURLS} from '@oracle-cx-commerce/react-widgets/session/user-profile-links/customconfig';
...
import css from '@oracle-cx-commerce/react-widgets/session/user-profile-links/mobile.css';
...
const ProfileLinks = props => {
  const {linkslist, isB2BUser} = props;

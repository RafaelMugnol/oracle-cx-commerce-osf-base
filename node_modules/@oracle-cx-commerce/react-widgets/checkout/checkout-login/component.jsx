...
import css from '@oracle-cx-commerce/react-widgets/checkout/checkout-login/styles.css';
        ...
        {!isUserLoggedIn && (
          <>
            ...
            <Form action="login" onOk={onOk} onNotOk={onNotOk} setInProgress={setInProgress} noValidate>
              ...
              <button className="CheckoutLogin__CheckoutButton" type="submit" disabled={inProgress}>
                {actionCheckout}
              </button>
            </Form>
...
export default connect(getComponentData)(CheckoutLogin);

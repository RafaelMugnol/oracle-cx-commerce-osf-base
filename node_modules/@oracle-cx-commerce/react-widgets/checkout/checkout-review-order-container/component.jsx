...
import css from '@oracle-cx-commerce/react-widgets/checkout/checkout-review-order-container/styles.css';
import ReviewOrderPlaceholder from '@oracle-cx-commerce/react-widgets/checkout/checkout-review-order-container/components/review-order-placeholder';
import PageLoader from '@oracle-cx-commerce/react-components/page-loader';
import {getComponentData} from '@oracle-cx-commerce/react-widgets/checkout/checkout-review-order-container/selectors';
 ...
 * @param {*} props
 */
const CheckoutReviewOrderContainer = props => {
  //props
  const {
    headingReviewOrder,
    regions = [],
...
export default connect(getComponentData)(CheckoutReviewOrderContainer);

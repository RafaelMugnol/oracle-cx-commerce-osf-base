...
import {getComponentData} from '@oracle-cx-commerce/react-widgets/checkout/checkout-payment-methods-container/selectors';
...
import css from '@oracle-cx-commerce/react-widgets/checkout/checkout-payment-methods-container/styles.css';
 ...
 * @param props
 */
const CheckoutPaymentMethodsContainer = props => {
  // props
...
CheckoutPaymentMethodsContainer.propTypes = {
  /**
...
CheckoutPaymentMethodsContainer.defaultProps = {
  orderState: undefined,
  paymentGroups: undefined
};

export default connect(getComponentData)(CheckoutPaymentMethodsContainer);

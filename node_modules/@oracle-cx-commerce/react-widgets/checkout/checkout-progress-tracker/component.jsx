...
import css from '@oracle-cx-commerce/react-widgets/checkout/checkout-progress-tracker/styles.css';
import {getComponentData} from '@oracle-cx-commerce/react-widgets/checkout/checkout-progress-tracker/selectors';
 ...
 */
const CheckoutProgressTracker = props => {
  //resources
  ...
  return (
    <Styled id="CheckoutProgressTracker" css={css}>
      <div className="CheckoutProgressTracker">
        <h1 className="CheckoutProgressTracker__heading">{headingCheckout}</h1>
        <ul className="CheckoutProgressTracker__wrapper">
          {(Object.keys(checkoutPagesData || {}) || []).map(step => (
            <li key={step} className="CheckoutProgressTracker__step">
              <div
                data-text={checkoutPagesData[step].index}
                className={`${
                  currentActiveTab >= checkoutPagesData[step].index ? 'CheckoutProgressTracker__markerActive' : ''
                } CheckoutProgressTracker__marker`}
              >
                <button
                  type="button"
                  className="CheckoutProgressTracker__label"
...
CheckoutProgressTracker.defaultProps = {
  currentOrder: {}
};

export default connect(getComponentData)(CheckoutProgressTracker);

...
import { ORDER_STATE_QUOTED, PAGE_CHECKOUT_PAYMENT_AND_REVIEW_ORDER_LINK, PAGE_CHECKOUT_PAYMENT_LINK, SHIPPING_GROUP_HARDGOOD } from '@oracle-cx-commerce/commerce-utils/constants';
...
import { getQuoteOrderSGPayload, loadShippingMethodsAndSetDefaultForSG } from '@oracle-cx-commerce/react-components/utils/address';
...
import css from '@oracle-cx-commerce/react-widgets/checkout/checkout-continue-to-payment-button/styles.css';
import { noop } from '@oracle-cx-commerce/utils/generic';
import { useComponentData } from '@oracle-cx-commerce/react-widgets/checkout/checkout-continue-to-payment-button/selectors';
 ...
 * @param props
 */
const CheckoutContinueToPaymentButton = props => {
  // resources
  const {
    actionConfirm,
    actionContinue,
  ...
  //selector
  const { isUserLoggedIn, shippingGroups, currentOrderId, currentOrder, quotePage } = useComponentData();
  ...
  }, [onNotOk, setShippingStatus, store, currentOrder]);
  ...
  return (
    <Styled id="CheckoutContinueToPaymentButton" css={css}>
      <div className="CheckoutContinueToPaymentButton">
        <button
          type="button"
          disabled={!enableContinue || !enableSchedledOrderContinue}
          className={`CheckoutContinueToPaymentButton__Continue ${(!enableContinue || !enableSchedledOrderContinue) && 'CheckoutContinueToPaymentButton__Continue--disabled'
            } `}
          onClick={handleClick}
        >
...
CheckoutContinueToPaymentButton.propTypes = {
  id: PropTypes.string.isRequired
};

export default CheckoutContinueToPaymentButton;

...
import css from '@oracle-cx-commerce/react-widgets/checkout/checkout-single-shipping-details/components/add-new-address/styles.css';
    ...
    <Styled id="AddNewAddress" css={css}>
      <div className="AddNewAddress">
        ...
        >
          ...
          <span className="AddNewAddress__Label">{labelAddANewAddress}</span>
        </div>

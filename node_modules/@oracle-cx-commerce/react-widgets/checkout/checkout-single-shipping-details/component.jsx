...
import css from '@oracle-cx-commerce/react-widgets/checkout/checkout-single-shipping-details/styles.css';
import {fetchShippingCountries} from '@oracle-cx-commerce/fetchers/shipping-countries';
import {getComponentData} from '@oracle-cx-commerce/react-widgets/checkout/checkout-single-shipping-details/selectors';
import {
 ...
 * @param props
 */
const CheckoutSingleShippingDetails = props => {
  // resources
  ...
  return (
    <Styled css={css} id="CheckoutSingleShippingDetails">
      <div className="CheckoutSingleShippingDetails">
...
CheckoutSingleShippingDetails.propTypes = {
  /**
...
CheckoutSingleShippingDetails.defaultProps = {
  contactInfos: {},
  roles: [],
  defaultShippingCountry: ''
};

export default connect(getComponentData)(CheckoutSingleShippingDetails);

...
import CheckoutSavedCardItem from '@oracle-cx-commerce/react-widgets/checkout/checkout-credit-card/components/checkout-saved-cards/checkout-saved-card-item';
 ...
 */
const CheckoutSavedCards = props => {
  const {
...
export default connect(getCheckoutSavedCardsData)(CheckoutSavedCards);

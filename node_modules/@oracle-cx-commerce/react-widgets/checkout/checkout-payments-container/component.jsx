...
import {getCheckoutPaymentsContainerData} from '@oracle-cx-commerce/react-widgets/checkout/checkout-payments-container/selectors';
import Styled from '@oracle-cx-commerce/react-components/styled';
import css from '@oracle-cx-commerce/react-widgets/checkout/checkout-payments-container/styles.css';
 ...
 * @param props
 */
const CheckoutPaymentsContainer = props => {
  const {
    id,
    isUserLoggedIn,
    regions = [],
  ...
  return (
    <Styled id="CheckoutPaymentsContainer" css={css}>
      <PaymentsContext.Provider value={paymentContext}>
        <div
          className={`CheckoutPaymentsContainer__FetchingPaymentText ${
            !isLoading ? ' CheckoutPaymentsContainer--hidden' : ''
          }`}
        >
          <span>{textRetrievingPaymentDetails}</span>
        </div>
        <div className={`${isLoading ? ' CheckoutPaymentsContainer--hidden' : ''}`}>
          <div className="CheckoutPaymentsContainer__Header">
            <h2>{headingPayment}</h2>
          </div>
          {paymentsAlertMessage && paymentsAlertMessage.message && (
            <div className="CheckoutPaymentsContainer__AlertMessage">
              <Alert
          ...
          <section className="CheckoutPaymentsContainer__Section">
...
CheckoutPaymentsContainer.propTypes = {
  /**
...
CheckoutPaymentsContainer.defaultProps = {
  isApprovalEnabled: undefined
};

export default connect(getCheckoutPaymentsContainerData)(CheckoutPaymentsContainer);

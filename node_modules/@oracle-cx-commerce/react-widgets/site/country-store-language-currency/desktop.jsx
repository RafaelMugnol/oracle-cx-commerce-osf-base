...
import css from '@oracle-cx-commerce/react-widgets/site/country-store-language-currency/desktop.css';
 ...
 */
const CountryStoreLanguageCurrencyDesktop = props => {
...
CountryStoreLanguageCurrencyDesktop.propTypes = {
...
CountryStoreLanguageCurrencyDesktop.defaultProps = {
  allSites: {},
  additionalLanguages: [],
  priceListGroupList: []
};

export default connect(getSiteData)(CountryStoreLanguageCurrencyDesktop);

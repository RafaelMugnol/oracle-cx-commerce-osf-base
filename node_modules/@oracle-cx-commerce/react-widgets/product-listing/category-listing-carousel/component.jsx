...
import css from '@oracle-cx-commerce/react-widgets/product-listing/category-listing-carousel/styles.css';
import GenericCarousel from '@oracle-cx-commerce/react-components/generic-carousel';
import ProductItem from '@oracle-cx-commerce/react-widgets/product-listing/category-listing-carousel/components/product-item';
...
CategoryListingCarousel.propTypes = {
  ...
  /** No of of items to display per slide in Desktop mode. */
  itemsPerSlideDesktop: PropTypes.string.isRequired,

  /** No of of items to slide at a time Desktop mode. */
  noOfItemsToSlide: PropTypes.string,

  /** Flag to display the name of collection or a value from text snippet */
  displayCollectionName: PropTypes.string
};

CategoryListingCarousel.defaultProps = {

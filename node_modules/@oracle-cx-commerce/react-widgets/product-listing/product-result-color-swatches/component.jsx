...
import css from '@oracle-cx-commerce/react-widgets/product-listing/product-result-color-swatches/styles.css';
 ...
 * @param props
 */
const ProductResultColorSwatches = props => {
  const {
...
ProductResultColorSwatches.propTypes = {
  /**
...
ProductResultColorSwatches.defaultProps = {
  colorIndicator: 'firstFew',
  numberOfSwatchesDisplayed: '5',
  colorSwatchShape: 'circular',
  colorSwatchImageHeight: 24,
...
export default ProductResultColorSwatches;

...
import css from '@oracle-cx-commerce/react-widgets/product-listing/search-terms-summary/styles.css';
import {getPageData} from '@oracle-cx-commerce/react-widgets/product-listing/search-terms-summary/selectors';
 ...
 * @param props
 */
const SearchTermsSummary = props => {
  ...
  if (originalSearch) {
    ...
    if ('suggestedSearches' in searchAdjustments) {
      ...
      const suggestionList = suggestionLabels.map((label, index) => (
        <span key={label}>
          <Link className="SearchTermsSummary__SuggestedSearch" href={`${route}?Ntt=${label}`}>
            <q>{label}</q>
          </Link>
    ...
    if ('adjustedSearches' in searchAdjustments) {
      ...
      searchInfo = (
        <div className="SearchTermsSummary__SearchAdjusted">
          <div
      ...
      searchInfo = (
        <div className="SearchTermsSummary__OriginalSearch">
      ...
      // No matching results
      searchInfo = (
        <div className="SearchTermsSummary__NoResults">
    ...
    return (
      <Styled id="SearchTermsSummary" css={css}>
        <div className="SearchTermsSummary__Container">{searchInfo}</div>
      </Styled>
    );
  }
 ...
 */
export default connect(getPageData)(SearchTermsSummary);

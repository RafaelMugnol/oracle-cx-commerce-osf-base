...
import css from '@oracle-cx-commerce/react-widgets/product-listing/product-result-price/styles.css';
 ...
 * @param props
 */
const ProductResultPrice = props => {
  const {
...
export default ProductResultPrice;

...
import css from '@oracle-cx-commerce/react-widgets/product-listing/product-result-image-quick-view/components/quick-view-button/styles.css';
import {objToClassName, noop} from '@oracle-cx-commerce/utils/generic';

// Lazy load Quick View
const QuickView = React.lazy(() =>
  import('@oracle-cx-commerce/react-widgets/product-listing/product-result-image-quick-view/components/quick-view')
);
    ...
    event => {
      ...
      if (record.attributes['product.repositoryId']) {
        getData(action, record.attributes['product.repositoryId'], response => {
          ...
          setProduct(products[record.attributes['product.repositoryId']]);
        });
      }

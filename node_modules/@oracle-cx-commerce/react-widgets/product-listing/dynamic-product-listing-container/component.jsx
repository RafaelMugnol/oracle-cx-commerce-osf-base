...
import {PAGINATION_PARAM_PAGE, PRODUCT_LISTING_PAGE_TYPES} from '@oracle-cx-commerce/commerce-utils/constants/page-links';
...
const DynamicProductListingContainer = props => {
  const {regions = [], mobile, searchResults, page, contextId, pageId, pageType, searchServicePath} = props;
  ...
  useEffect(() => {
    // update linkTags for product listing pages according to search results
    if (PRODUCT_LISTING_PAGE_TYPES.includes(pageType) && searchResults.results) {

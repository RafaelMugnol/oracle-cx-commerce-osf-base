...
import {PAGE_PURCHASE_LISTS_LINK} from '@oracle-cx-commerce/commerce-utils/constants';
import Styled from '@oracle-cx-commerce/react-components/styled';
import css from '@oracle-cx-commerce/react-widgets/profile/profile-purchase-list-action-buttons/components/delete-purchase-list/styles.css';
...
const DeletePurchaseList = props => {
  ...
  const onOk = useCallback(() => {
    toggleDeleteModal();
    goToPage(PAGE_PURCHASE_LISTS_LINK);

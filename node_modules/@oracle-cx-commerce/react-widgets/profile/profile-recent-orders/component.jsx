...
import css from '@oracle-cx-commerce/react-widgets/profile/profile-recent-orders/styles.css';
 ...
 */
const ProfileRecentOrders = props => {
  ...
  return (
    <Styled id="ProfileRecentOrders" css={css}>
      <div className="ProfileRecentOrders">
...
export default connect(getProfileOrdersData)(ProfileRecentOrders);

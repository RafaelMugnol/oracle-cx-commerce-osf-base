...
import {PAGE_CART_LINK, PAGE_PURCHASE_LISTS_LINK} from '@oracle-cx-commerce/commerce-utils/constants';
...
import ProfilePurchaseListItemData from '@oracle-cx-commerce/react-widgets/profile/profile-purchase-list-information/components/profile-purchaselist-item-data';
import PropTypes from 'prop-types';
import SearchIcon from '@oracle-cx-commerce/react-components/icons/search';
import SearchResultsPanel from '@oracle-cx-commerce/react-widgets/profile/profile-purchase-list-information/components/profile-purchaselist-search-results';
import Styled from '@oracle-cx-commerce/react-components/styled';
import css from '@oracle-cx-commerce/react-widgets/profile/profile-purchase-list-information/styles.css';
 ...
 */
const ProfilePurchaseListInformation = props => {
  //resources
  const {
    headingAddAProduct,
  ...
  const purchaseListsPage = PAGE_PURCHASE_LISTS_LINK;
  ...
  const gotoPurchaseListsPage = event => {
    event.preventDefault();
    goToPage(purchaseListsPage);
  };

  return (
    <Styled id="ProfilePurchaseListInformation" css={css}>
      <ContainerContext.Provider value={{selections, setSelections}}>
        {purchaseListId && (
          <div className="ProfilePurchaseListInformation">
            <Form
            ...
            >
              {((transformedList && transformedList.length > 0) || transformedListEmptied) && isEditable && (
                <div className="ProfilePurchaseListInformation__FormButtons">
                  <button
                    type="submit"
                    className="ProfilePurchaseListInformation__SubmitButton"
                    data-testid="ProfilePurchaseListInformation__SubmitButtonTop"
                  >
                    {labelSaveChangesToItemsInPurchaseList}
                  </button>
                  <button
                    type="button"
                    className="ProfilePurchaseListInformation__CancelButton secondary"
                    data-testid="ProfilePurchaseListInformation__CancelButtonTop"
              ...
              {isEditable && (
                <div className="ProfilePurchaseListInformation__AddProduct">
                  <h2 className="primary-heading">{headingAddAProduct}</h2>
                  <div className="ProfilePurchaseListInformation__Search">
                    <label htmlFor={`ProductSearch`}>{}</label>
                    <div className="ProfilePurchaseListInformation__SearchIcon">
                      <SearchIcon />
                    </div>
                    <div>
                      <input
                        ...
                        className="ProfilePurchaseListInformation__SearchInput"
                      ...
                      <button
                        type="button"
                        className="ProfilePurchaseListInformation_Search__ClearButton"
                        ref={searchClearRef}
                        onClick={onClear}
                      >
                        {actionClear}
              ...
              {transformedList && transformedList.length > 0 && (
                <div className="ProfilePurchaseListInformation__UpdateItem">
                  <div className="ProfilePurchaseListInformation__DeselectAll">
                    {selectAllToggle ? (
                      <button
                        type="button"
                        className="ProfilePurchaseListInformation__DeselectAllButton secondary"
                        onClick={event => {
                      ...
                      <button
                        type="button"
                        className="ProfilePurchaseListInformation__SelectAllButton secondary"
                        onClick={event => {
                  ...
                  <ProfilePurchaseListItemData
                    ...
                    {...props}
                  />
                  <div className="ProfilePurchaseListInformation__AddToCart">
                    <button
                      type="button"
                      disabled={!addToCartButtonView}
                      className="ProfilePurchaseListInformation__AddToCartButton secondary"
                  ...
                  {isEditable && (
                    <div className="ProfilePurchaseListInformation__FormButtons ProfilePurchaseListInformation__FormButtonsPageEnd">
                      <button
                        type="submit"
                        className="ProfilePurchaseListInformation__SubmitButton"
                        data-testid="ProfilePurchaseListInformation__SubmitButtonBottom"
                      >
                        {labelSaveChangesToItemsInPurchaseList}
                      </button>
                      <button
                        type="button"
                        className="ProfilePurchaseListInformation__CancelButton secondary"
                        data-testid="ProfilePurchaseListInformation__CancelButtonBottom"
                        onClick={gotoPurchaseListsPage}
                      >
                        {labelCancel}
                      </button>
              ...
              {transformedList && transformedList.length === 0 && (
                <div className="ProfilePurchaseListInformation__UpdateItem">{textNoItemsToDisplay}</div>
              )}
              {typeof window !== 'undefined' && (
                <MergeCartItemsModal
...
ProfilePurchaseListInformation.propTypes = {
  /** Number of results to load on searching for a product */
  numberOfSearchResultsToLoad: PropTypes.number
};

ProfilePurchaseListInformation.defaultProps = {
  numberOfSearchResultsToLoad: 5
};

export default ProfilePurchaseListInformation;

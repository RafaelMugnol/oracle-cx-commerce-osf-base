...
import css from '@oracle-cx-commerce/react-widgets/profile/profile-purchase-list-information/components/profile-purchaselist-search-results/styles.css';
...
import {getSearchResults} from '@oracle-cx-commerce/react-widgets/profile/profile-purchase-list-information/components/profile-purchaselist-search-results/selectors';
  ...
  return (
    <Styled id="PurchaseList__SearchResults" css={css}>
      {records && records.length > 0 && (
        <div className={'PurchaseList__SearchResults'}>
          {records &&

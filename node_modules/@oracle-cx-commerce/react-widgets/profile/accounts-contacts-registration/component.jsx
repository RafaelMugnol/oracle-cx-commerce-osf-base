...
import css from '@oracle-cx-commerce/react-widgets/profile/accounts-contacts-registration/styles.css';
 ...
 * @param props
 */
const AccountsAndContactsRegistration = props => {
  ...
  return (
    <Styled id="AccountAndContactRegistration" css={css}>
      <div className="AccountAndContactRegistration">
...
AccountsAndContactsRegistration.propTypes = {
  /**
...
AccountsAndContactsRegistration.defaultProps = {
  shippingCountries: {}
};
export default connect(getComponentData)(AccountsAndContactsRegistration);

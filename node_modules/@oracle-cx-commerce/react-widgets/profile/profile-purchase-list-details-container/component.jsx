...
import css from '@oracle-cx-commerce/react-widgets/profile/profile-purchase-list-details-container/styles.css';
import {getComponentData} from '@oracle-cx-commerce/react-widgets/profile/profile-purchase-list-details-container/selectors';

/**
 * Container that holds all the widgets for the Purchase List Details Page
 */
const ProfilePurchaseListDetailsContainer = props => {
  ...
  return (
    <Styled id="ProfilePurchaseListDetailsContainer" css={css}>
      <div className="ProfilePurchaseListDetailsContainer">
        {purchaseList && (
          <>
            <ContainerContext.Provider value={purchaseList}>
              <section className="ProfilePurchaseListDetailsContainer__Section">
...
export default connect(getComponentData)(ProfilePurchaseListDetailsContainer);

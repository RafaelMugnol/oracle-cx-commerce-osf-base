...
import css from '@oracle-cx-commerce/react-widgets/profile/profile-saved-card-summary/styles.css';
 ...
 */
const ProfileSavedCardSummary = props => {
  ...
  return (
    <Styled id="ProfileSavedCardSummary" css={css}>
      {isUserLoggedIn && actionCompletedSuccessfully && !errorOccured && (
        <div className="ProfileSavedCardSummary">
...
ProfileSavedCardSummary.propTypes = {
  /**
 ...
 */
ProfileSavedCardSummary.defaultProps = {
  cardType: null,
  defaultCard: undefined
};

export default connect(getPageData)(ProfileSavedCardSummary);

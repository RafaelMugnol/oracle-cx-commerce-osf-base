...
import css from '@oracle-cx-commerce/react-widgets/profile/profile-order-details-container/styles.css';
import {getOrderData} from '@oracle-cx-commerce/react-widgets/profile/profile-order-details-container/selectors';
import PropTypes from 'prop-types';

/**
 * Container that holds all the widget for the Order Details Page
 */
const ProfileOrderDetailsContainer = props => {
  ...
  return (
    <Styled id="ProfileOrderDetailsContainer" css={css}>
      <div className="ProfileOrderDetailsContainer">
        {order && order.id && (
          <React.Fragment>
            <h1>{headingOrderDetails}</h1>
            <OrderContext.Provider value={order}>
              <ProductSelectionContext.Provider value={{productSelection, setProductSelection}}>
                <section className="ProfileOrderDetailsContainer__Section">
...
ProfileOrderDetailsContainer.propTypes = {
...
export default connect(getOrderData)(ProfileOrderDetailsContainer);

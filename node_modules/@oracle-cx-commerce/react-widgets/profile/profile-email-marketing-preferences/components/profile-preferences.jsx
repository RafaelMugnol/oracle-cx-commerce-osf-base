...
import ProfileEmailPreference from '@oracle-cx-commerce/react-widgets/profile/profile-email-marketing-preferences/components/profile-email-preference';
import ProfileGDPRConsent from '@oracle-cx-commerce/react-widgets/profile/profile-email-marketing-preferences/components/profile-gdpr-consent';
import {StoreContext} from '@oracle-cx-commerce/react-ui/contexts';
import Styled from '@oracle-cx-commerce/react-components/styled';
import css from '@oracle-cx-commerce/react-widgets/profile/profile-email-marketing-preferences/components/styles.css';
          ...
          <div className="ProfilePreferences__Form">
            ...
            <div className="ProfilePreferences__Buttons">
              ...
              <button
                type="button"
                disabled={inProgress}
                className="ProfilePreferences__CancelButton secondary"
                onClick={() => goToPage(PAGE_PROFILE_LINK)}
              >
                {actionCancel}
              </button>
            </div>

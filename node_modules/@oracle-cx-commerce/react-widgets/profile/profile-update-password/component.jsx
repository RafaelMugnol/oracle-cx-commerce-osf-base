...
import css from '@oracle-cx-commerce/react-widgets/profile/profile-update-password/styles.css';
...
const ProfileUpdatePassword = props => {
  ...
  return (
    <Styled id="ProfileUpdatePassword" css={css}>
            ...
            >
                ...
                )}
              {
                <div>
                  <div className="ProfileUpdatePassword__InputElement">
                    ...
                    <div className="ProfileUpdatePassword__InputElementIconDiv">
                      <PasswordIcon className="ProfileUpdatePassword__IconBasicStyle" />
                    </div>
              ...
              <div className="ProfileUpdatePassword__Buttons">
                ...
                <button
                  ...
                  className="ProfileUpdatePassword__CancelButton secondary"

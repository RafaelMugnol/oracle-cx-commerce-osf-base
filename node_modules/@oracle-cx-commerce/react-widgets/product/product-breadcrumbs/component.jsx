...
import css from '@oracle-cx-commerce/react-widgets/product/product-breadcrumbs/styles.css';
 ...
 * ProductBreadcrumbs are applied to product, collections and search results pages.
 *
 * @param props
 */
const ProductBreadcrumbs = props => {
      ...
      return (
        <Styled id="ProductBreadcrumbs" css={css}>
          <div className="ProductBreadcrumbs">
            <Link className="ProductBreadcrumbs__BreadcrumbLink" href=".">
              {t(textHome)}
            </Link>
            {divider}
            {previousBreadcrumbs.searchCrumbs.map(crumbData => (
              <Link
                className="ProductBreadcrumbs__BreadcrumbLink"
              ...
              >
                ...
                >
                  <span className={crumbData.correctedTerms && 'ProductBreadcrumbs__CorrectedLabel'}>
                    &quot;{crumbData.terms}&quot;
                  </span>
        ...
        <div className="ProductBreadcrumbs">
          ...
          {parentCategories.map(category => (
            <span key={category.id}>
              {divider}
              <Link className="ProductBreadcrumbs__BreadcrumbLink" href={category.route}>
  ...
  return <Styled id="ProductBreadcrumbs" css={css} />;
};
...
export default connect(getPageData)(ProductBreadcrumbs);

...
const MultiSelectMenuGrid = ({
  ...
  return (
    <Styled id="ConfiguratorMultiSelectMenuGrid" css={css}>
      <div className="ConfiguratorMultiSelectMenuGrid__Container">
        <fieldset className="ConfiguratorMultiSelectMenuGrid__Fieldset" ref={inputRef}>
          <legend className="ConfiguratorMultiSelectMenuGrid__Legend">{name}</legend>
          {menuItems.map((item, index) => {
            return (
              <label htmlFor={`${uniqueId}-${index}`} key={item.value}>
                ...
                />
                <img
                  src={item.imageUrl ? item.imageUrl : '/img/no-image.jpg'}
...
MultiSelectMenuGrid.defaultProps = {
  inputRef: null
};

export default MultiSelectMenuGrid;

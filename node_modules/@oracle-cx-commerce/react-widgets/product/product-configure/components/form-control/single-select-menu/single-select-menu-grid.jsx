...
const SingleSelectMenuGrid = ({
   ...
   *
   */
  const handleSingleSelectMenuChange = item => {
    const newValue = {value: item.value}; // TODO: Add more entries as required to the implementation and payload
  ...
  return (
    <Styled id="ConfiguratorSingleSelectMenuGrid" css={css}>
      <div className="ConfiguratorSingleSelectMenuGrid__Container">
        <fieldset className="ConfiguratorSingleSelectMenu__Fieldset">
          <legend className="ConfiguratorSingleSelectMenu__Legend">{name}</legend>
          {menuItems.map((item, index) => {
            return (
              <div key={`${uniqueId}-${item.value}`}>
                <Radio
                  id={`${uniqueId}-${index}`}
                  type="radio"
                  value={item.value}
                  onChange={() => handleSingleSelectMenuChange(item)}
                  name={variableName}
...
SingleSelectMenuGrid.propTypes = {
  /**
...
SingleSelectMenuGrid.defaultProps = {
  inputRef: null,
  defaultValue: null
};

export default SingleSelectMenuGrid;

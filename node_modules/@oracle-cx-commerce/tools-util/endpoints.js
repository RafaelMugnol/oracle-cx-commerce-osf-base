...
const getDeploymentEnvironment = async options => {
  ...
  try {
    ...
    const response = await restClient.request({
      method: 'get',
      url: `/ccadmin/v1/deploymentEnvironment/${clusterId}`,
      headers: {
...
const getDeploymentEnvironments = async options => {
  ...
  try {
    ...
    const response = await restClient.request({
      method: 'get',
      url: `/ccadmin/v1/deploymentEnvironment/`,
      headers: {
        'Content-Type': 'application/json; charset=UTF-8',
        'X-CCAsset-Language': 'en'
      },
...
const downloadDeploymentById = async options => {
  ...
  const response = await restClient.request({
    method: 'get',
    url: `/ccadmin/v1/applicationDeployment/${deployId}`,
    responseType: 'stream'
  });
...
const downloadCurrentAppDeployment = async options => {
  ...
  const response = await restClient.request({
    method: 'get',
    url: `/ccadmin/v1/clientApplications/${appName}/currentDeployment`,
    params: {preview},
    responseType: 'stream'
  });
...
const deployApplication = async options => {
  ...
  const deployParams = {
    ...
    replaceApplication,
    resetApplication: options.reset ? true : false,
    ...options.deployParams
  };
  const response = await restClient.request({
    method: 'post',
...
/**
 * Deletes an application from OCC preview.
 *
 * If a rest client is not provided one will be created for making the endpoint
 * call
 *
...
const getDeploymentLog = async options => {
  ...
  const response = await restClient.request({
    method: 'get',
    url: `/ccadmin/v1/${reqAction}/${id}/logs`,
    headers: {
      'Content-Type': 'application/json; charset=UTF-8',
      'X-CCAsset-Language': 'en'
    },
...
const getPublishStatus = async options => {
  ...
  const response = await restClient.request({
    method: 'get',
    url: '/ccadmin/v1/publish?lastPublished=true',
    headers: {
      'Content-Type': 'application/json; charset=UTF-8',
      'X-CCAsset-Language': 'en'
    },
...
const getAppPublishChange = async options => {
  ...
  return restClient.request({
    method: 'get',
    url: '/ccadmin/v1/publishingChanges',
    params: {
...
const getChangeList = async options => {
  ...
  return restClient.request({
    method: 'post',
    url: '/ccadmin/v1/publishingChangeLists',
...
const getChangeListDependencies = async options => {
  ...
  return restClient.request({
    method: 'get',
    url: `/ccadmin/v1/publishingChangeLists/${changeListId}?limit=${limit || 40}&changes=dependencies`,
    headers: {
      'Content-Type': 'application/json; charset=UTF-8',
      'X-CCAsset-Language': 'en'
    },
...
const publish = async options => {
  ...
  const response = await restClient.request({
    method: 'post',
    url: '/ccadmin/v1/publishingChangeLists/publish',
    headers: {
      'Content-Type': 'application/json; charset=UTF-8',
      'X-CCAsset-Language': 'en'
    },
...
const redeploy = async options => {
  ...
  const response = await restClient.request({
    method: 'post',
    url: `/ccadmin/v1/deploymentEnvironment/${clusterName}/redeploy`,
...
const setLoggingConfig = async options => {
  ...
  const response = await restClient.request({
    method: 'post',
    url: `/ccadmin/v1/deploymentEnvironment/${clusterName}/configure`,
    headers: {
      'Content-Type': 'application/json; charset=UTF-8',
      'X-CCAsset-Language': 'en'
    },
...
const getApplicationDeployStatus = async options => {
  ...
  const response = await restClient.request({
    method: 'get',
    url: `/ccadmin/v1/clientApplications/${id}/status`,
    headers: {
      'Content-Type': 'application/json; charset=UTF-8',
      'X-CCAsset-Language': 'en'
    },
...
const getDeploymentDeployStatus = async options => {
  ...
  const response = await restClient.request({
    method: 'get',
    url: `/ccadmin/v1/applicationDeployment/${id}/status`,
    headers: {
      'Content-Type': 'application/json; charset=UTF-8',
      'X-CCAsset-Language': 'en'
    },
...
const getClusterDeployStatus = async options => {
  ...
  const response = await restClient.request({
    method: 'get',
    url: `/ccadmin/v1/deploymentEnvironment/${id}/status`,
    headers: {
      'Content-Type': 'application/json; charset=UTF-8',
      'X-CCAsset-Language': 'en'
    },
...
const downloadApplicationAssets = async options => {
  ...
  const response = await restClient.request({
    method: 'get',
    url: `/ccadmin/v1/clientApplications/${appName}/assets`,
    responseType: 'stream',
    params: {live: !preview}
  });
...
const disableBasicAuth = async options => {
  ...
  const response = await restClient.request({
    method: 'put',
    url: `/ccadminui/v1/merchant/basicAuth`,
    headers: {
...
const getClientApps = async options => {
  ...
  const response = await restClient.request({
    method: 'get',
    url: '/ccadmin/v1/clientApplications',
    responseType: 'json'
  });
...
const getDeploymentsList = async options => {
  ...
  try {
    ...
    const response = await restClient.request({
      method: 'get',
      url: `/ccadminui/v1/applicationDeployment?appName=${appName}`,
      headers: {

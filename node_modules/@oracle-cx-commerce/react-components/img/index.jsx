...
import MissingImageIcon from '@oracle-cx-commerce/react-components/icons/missing-image';
import {StoreContext} from '@oracle-cx-commerce/react-ui/contexts';
import Styled from '@oracle-cx-commerce/react-components/styled';
import {IMG_CONF as config} from '@oracle-cx-commerce/react-components/config';
import css from '@oracle-cx-commerce/react-components/img/styles.css';
...
const Img = props => {
  ...
  const renderImg = () => {
    ...
    return errorSrcFinal ? (
      ...
      <MissingImageIcon className="Img__MissingImgIcon" />
    );
  };

  return (
    <Styled id="Img" css={css}>
      <div className="Img__Wrapper">{renderImg()}</div>
    </Styled>
  );
};

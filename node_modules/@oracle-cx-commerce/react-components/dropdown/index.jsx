...
import css from '@oracle-cx-commerce/react-components/dropdown/styles.css';
...
const Dropdown = ({
  ...
  return (
    <Styled id="Dropdown" css={css}>
      <div className={`Dropdown ${className}`}>
        <label htmlFor={id}>{label}</label>
        <div className="Dropdown__Select">
          <div className="Dropdown__Icon">{isSingleSelect && icon}</div>
          <select
            id={id}
            aria-label={arialLabel}
            disabled={disabled}
            ...
            data-testid={dataTestId}
            className={`${isSingleSelectWithBackground ? 'Dropdown__Select--WithBackgroundIcon' : ''}`}
            style={

    ...
    for (const recWidget of recsWidgets) {
      ...
      if (strategy !== 'Blended' && strategy !== '') {
        ...
        if (RULE_MAP[strategy]) {
          ...
          // Otherwise, a custom strategy must have been chosen, in which case, strategy is a JSON string. Just return a
          // strategyId field with the strategy ID.
          slotObject.strategyId = JSON.parse(strategy).id;

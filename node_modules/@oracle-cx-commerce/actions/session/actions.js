...
export default {
  reducer: combineReducers({
    orderRepository: createReducer({[UNAUTHORIZED]: expireOrderReducer, [LOGOUT_SUCCESS]: expireOrderReducer}),
    profileRepository: createReducer({[UNAUTHORIZED]: expireProfileReducer, [LOGOUT_SUCCESS]: expireProfileReducer}),
    ...
    csrRepository: createReducer({[UNAUTHORIZED]: expireReturnReducer, [LOGOUT_SUCCESS]: expireReturnReducer})
  }),

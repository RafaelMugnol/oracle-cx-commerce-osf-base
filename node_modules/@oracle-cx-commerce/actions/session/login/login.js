...
import {all, delay, put, select, spawn, take} from 'redux-saga/effects';
...
export function* registerEndpointsInvokedTime() {
  while (true) {
    ...
    if (action.endpointId === 'refresh' || action.endpointId === 'ccRefreshUser') {
...
export default {
  ...
  *saga() {
    yield all([takeLeading('login', loginSaga)]);
  }
};

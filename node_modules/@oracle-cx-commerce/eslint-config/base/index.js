...
const prettierConfig = require('@oracle-cx-commerce/prettier-config');
...
module.exports = {
  ...
  rules: {
    ...
    /**
     * Rules overlaid from eslint-config-osf-base core.js
     */
    ...
    'import/no-extraneous-dependencies': [
      'off',
      {
        ...
        devDependencies: [
          ...
          'test/unit/**', // osf workspace unit tests pattern
    ...
    },
    {
      ...
      rules: {
        'no-restricted-imports': [
          ...
          {
            patterns: [
              '@oracle-cx-commerce/react-components-unreleased/*',
              '@oracle-cx-commerce/react-widgets-unreleased/*'
            ]
          }
        ]
      }
